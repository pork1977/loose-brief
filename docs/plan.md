...
| 8 | Export | The homepage as a self-contained static site (HTML + CSS from the tokens, zipped, opens in a browser or drops onto any host), then CSS, JSON, Tailwind, DESIGN.md, guidelines HTML, copy deck, social cards. Added 2026-09-14 because the landing page promises a website people can take away, and token files alone don't deliver that. **Loose Brief will never host sites** (Paul, 2026-09-14): it is a design tool, and everything leaves as an export |
